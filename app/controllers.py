...
@controllers.route('projects/new', methods=['POST'])
def new_project():
...
@controllers.route('projects', methods=['GET'])
...
@controllers.route('projects/<int:project_id>', methods=['GET'])
...
@controllers.route('projects/<int:project_id>/delete', methods=['DELETE'])
...
@controllers.route('projects/<int:project_id>/update', methods=['POST'])
...
@controllers.route('clients/<int:client_id>', methods=['GET'])
...
@controllers.route('clients/<int:client_id>/projects', methods=['GET'])
...
@controllers.route('clients/new', methods=['POST'])
def new_client():
...
@controllers.route('clients/<int:client_id>/delete', methods=['DELETE'])
...
@controllers.route('clients/<int:client_id>/update', methods=['POST'])
